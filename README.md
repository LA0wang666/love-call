...
<body>
    <div class="container">
        ...
        <div class="photo-frame">
            <!-- 将下面的图片URL替换为你的图片地址 -->
            <img class="photo" src="[<a href='https://postimages.org/' target='_blank'><img src='https://i.postimg.cc/QBJqNSXH/image.png' border='0' alt='image'/></a>](https://i.postimg.cc/MKds4GgG/image.png)" alt="我们的照片">
        </div>
